      ...
      <div className="relative z-30 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="text-center animate-fade-in flex flex-col items-center">
          <div className="flex w-full flex-col items-center justify-center">
            ...
            />
            <p className="-mt-32 sm:-mt-36 md:-mt-40 lg:-mt-44 text-xl sm:text-2xl text-[#60a5fa] font-light text-center w-full" dir="rtl">
              علمٌ يُستفاد، ونورٌ يُستزاد
            </p>
          </div>

          <p className="mt-6 text-lg sm:text-xl text-[#cfe3ff]/90 max-w-2xl mx-auto mb-10 text-center leading-[1.65]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full sm:w-auto">
            <Link
              to="/portfolio"
              className="min-w-[190px] px-7 py-3.5 bg-[#60a5fa] text-[#cfe3ff] rounded-xl text-base font-semibold hover:bg-[#60a5fa]/90 transition-all transform hover:scale-[1.02] shadow-xl"
            >
            ...
            <Link
              to="/contact"
              className="min-w-[190px] px-7 py-3.5 bg-transparent border-2 border-[#cfe3ff] text-[#cfe3ff] rounded-xl text-base font-semibold hover:bg-[#93c5fd]/20 hover:text-[#cfe3ff] transition-all transform hover:scale-[1.02]"
            >
